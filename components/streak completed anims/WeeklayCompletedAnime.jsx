...
export const AchievementAndStreakUpdate = ({
    goalName,
    daysCompleted,
    onRefresh,
    showUpdateGoals,
        ...
        <AnimatePresence>
            {(showAnimation) && (
                ...
                >
                    {showAnimation && (
                        ...
                        >
                            <motion.div variants={iconVariants}>
                                <Icon
                                    className={`w-24 h-24 mx-auto ${style.iconColor}`}
                                />
                            </motion.div>
                            <motion.h2
                            ...
                            >
                                {[...Array(5)].map((_, i) => (
                                    <Star
                                        key={i}
                                        className={`w-8 h-8 ${style.iconColor} fill-current`}
                                    />
                                ))}
                            </motion.div>
                        </motion.div>
                    ...
                    {showStreakUpdate && parseInt(showUpdateGoals) === parseInt(daysCompleted) && (
                        <motion.div
                        ...
                        >
                            ...
                            <div className="mb-6">
                                <p className="text-gray-200 mb-2">
                                    Congratulations on reaching {daysCompleted}{" "}
                                    days! Set a new goal to keep your streak
                                    going.
                                </p>
                                <div className="flex items-center mt-4">
                                    ...
                                    <p className="text-lg  font-semibold text-gray-300">
                                        Current Streak: {daysCompleted} days
                                    </p>
                                </div>
                            </div>
